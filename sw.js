...
const CACHE = "hesap-kitap-v42";
const ASSETS = [
  "/hesap-kitap/",
  "/hesap-kitap/index.html",
  "/hesap-kitap/css/style.css?v=20260207bank",
  ...
  "/hesap-kitap/manifest.json?v=20260207bank",
  "/hesap-kitap/icons/icon-180.png?v=20260207bank",
  "/hesap-kitap/icons/icon-192.png?v=20260207bank",
  "/hesap-kitap/icons/icon-256.png?v=20260207bank",
  "/hesap-kitap/icons/icon-512.png?v=20260207bank"
];
