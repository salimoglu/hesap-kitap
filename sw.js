...
const CACHE = "hesap-kitap-v102";
const BASE = self.location.pathname.replace(/\/?sw\.js$/i, "");
const ASSETS = [
  BASE + "/",
  BASE + "/index.html",
  BASE + "/css/style.css?v=20260224birikim-yil",
  BASE + "/js/app.js?v=20260514mobilpopup",
  BASE + "/js/db.js?v=20260225kat-sync",
  BASE + "/js/firebase.js?v=20260225kat-sync",
  BASE + "/js/modules/islemler.js?v=20260225kat-sync",
